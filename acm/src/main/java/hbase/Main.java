...
//        conf.set("hbase.zookeeper.quorum", "hbase18.hz.163.org,hbase19.hz.163.org,hbase20.hz.163.org");
//        conf.set("zookeeper.znode.parent", "/hbase");
//        conf.set("hbase.client.username", "ds");
//
//    }
//
//    /*
...
//        System.getProperties().setProperty("HADOOP_USER_NAME", "ds");
//
//
//        // 创建表
...
//
//        // 遍历查询
//        //getResultScann("easyds:testtable", "a", "z");
//        getResult("easyds:testtable", new String(new byte[]{(byte)1}));
//
//
//
//        // 根据row key范围遍历查询
